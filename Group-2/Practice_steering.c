...
signed int G_Str_SteeringAngle_sint = 6691u;
...
void Com_PackSteeringInformation(unsigned char *Byte_uchar)
{
	...
	G_Msg_SteeringInformation_Byte[0]=0x03& (G_Str_SteeringAngle_sint); //pushing last 4 byte values using right shift operator in array
	G_Msg_SteeringInformation_Byte[1]=0x23& (G_Str_SteeringAngle_sint );//storing the 8 bits from LSB in the array
	G_Msg_SteeringInformation_Byte[2]=0x68 & (G_Str_SteeringAngle_sint >>6); //pushing last 4 byte values using right shift operator in array
